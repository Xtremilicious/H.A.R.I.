  ...
  <div class="modal-dialog opened-report" role="document">
    <div class="modal-content">
      ...
      <div className="modal-nav">
        <div className="modal-nav-link"><Link to="/all-reports/" className="modal-nav-link">Pulse</Link></div>
        <div className="modal-nav-link"><Link to="/all-reports/report/ecg" className="modal-nav-link">ECG</Link></div>
        <div className="modal-nav-link"><Link to="/all-reports/report/emg" className="modal-nav-link">EMG</Link></div>
      </div>

      <Switch>
                <Route exact path="/all-reports/" component={Pulse}/>
                <Route path="/all-reports/report/ecg" component={ECGData}/>
                <Route path="/all-reports/report/emg" component={EMGData}/>
            </Switch>
